...
class TriTableauTest {
	...
	void testTriDecroissant(int tabDesc[], int resultat[]) {
		TriTableau.triCroissant(tabDesc);
		Assert.assertArrayEquals(resultat, tabDesc);
	}
	
	static Stream<Arguments> deCroissant() throws Throwable{
		int[] tab = new int[] {60,50,70};
		int[] resultat = new int[] {70,60,50};;
		int[] tab2 = new int[] {123,180,8,200};
		int[] resultat2 = new int[] {200, 180, 123, 8};
		return Stream.of(Arguments.of(tab, resultat),
				Arguments.of(tab2, resultat2));
	}
}